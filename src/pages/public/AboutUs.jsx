                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-gray-600 leading-relaxed mb-4">
                                Play2LearnLearning was born from a simple observation: traditional education often lacks engagement and interactivity. Our founders, educators and tech enthusiasts, asked themselves: "What if we could make learning as fun as games?"
                            </p>
                            <p className="text-gray-600 leading-relaxed mb-4">
                                Launched in 2020, our platform started with just 50 quizzes and a few thousand users. Today, we serve over a million learners in more than 50 countries, with a library of over 500 quizzes covering topics from science to programming.
                            </p>
                            <p className="text-gray-600 leading-relaxed">
                                Our success is built on a simple principle: when learners have fun, they learn better. That's why we continue to innovate, listen to our community, and push the boundaries of what online education can be.
                            </p>
                        </div>
                    </div>
                </div>
